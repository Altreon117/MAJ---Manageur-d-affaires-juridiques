...
from config import (JI_BACK_COLUMNS, JI_FILTER_COLUMNS, JI_FRONT_COLUMNS,
...
class JIView(QWidget):
    def __init__(self):
        ...
        for col_back, col_front in JI_FILTER_COLUMNS.items():
            # Titre du filtre
        ...
        # Utilisation de JI_FRONT_COLUMNS.items()
